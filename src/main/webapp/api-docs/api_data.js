define({ "api": [
  {
    ...
    "group": "C__git_templates_broker_src_main_webapp_api_docs_main_js",
    "groupTitle": "C__git_templates_broker_src_main_webapp_api_docs_main_js",
    "name": ""
  },
  {
    "type": "post",
  ...
  },
  {
    "type": "get",
    "url": "/templates",
    "title": "Listar templates excluídos",
    "name": "listTemplatesExcluidos",
    "group": "Template",
    "version": "1.0.0",
    "permission": [
      {
    ...
    "description": "<p>Consulta os templates que foram excluídos.</p>",
    "parameter": {
      "fields": {
        "Query Parameters": [
          {
  ...
  {
    "type": "delete",
    "url": "/templates/excluidos/:template",
    "title": "Recuperar template",
    "name": "undeleteTemplate",
    "group": "Template",
    "version": "1.0.0",
    "permission": [
      {
    ...
    "description": "<p>Recupera um template excluído.</p>",
    "parameter": {
      "fields": {
        "Path Parameters": [
          {
    ...
    "examples": [
      {
        "title": "Exemplo de requisição:\t",
        "content": "curl -X DELETE http://<host>/templates-broker/service/templates/excluidos/admp-template-novo-usuario",
        "type": "json"
      }
    ],
    "success": {
